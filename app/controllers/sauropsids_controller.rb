class SauropsidsController < ApplicationController
	...
	def create
		@sauropsid = Sauropsid.new(params.require(:sauropsid).permit(:order, :name, :age, :species, :location, :wingspan, :weight, :length, :image, :lat, :lng))
		if @sauropsid.save
	...
	def update
		@sauropsid = Sauropsid.find(params[:id])
		if @sauropsid.update_attributes(params.require(:sauropsid).permit(:order, :name, :age, :species, :location, :wingspan, :weight, :length, :image, :lat, :lng))
